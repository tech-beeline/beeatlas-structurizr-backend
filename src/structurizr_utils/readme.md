...
├── readme.md                    # Краткое описание (legacy)
├── .gitignore                   # Git ignore правила
├── functions/                   # Функции проверки архитектуры
│   ├── README.md               # 📖 [Документация функций проверки](./functions/README.md)
...
│   ├── README.md              # 📖 [Документация моделей данных](./models/README.md)
...
└── utils/                      # Вспомогательные утилиты
    ├── README.md             # 📖 [Документация утилит](./utils/README.md)
