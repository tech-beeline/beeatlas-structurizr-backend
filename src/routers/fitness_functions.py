...
from structurizr_utils.functions.ea_0001 import check_ea_0001
...
def fitness_check(docId: int,pipelineId : int = 0):
    ...
    try:
        ...
        result.extend(safe_execution(check_ea_0001,cmdb,data,url_sparx,share_url, False,product_id))
